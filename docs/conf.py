# -*- coding: utf-8 -*-
#
# agile-diamond documentation build configuration file, created by
...
from agile_diamond.__meta__ import __version__
version = __version__
...
htmlhelp_basename = 'agile_diamond_doc'
...
latex_documents = [
    ('index', 'agile-diamond.tex', u'agile-diamond Documentation',
...
man_pages = [
    ('index', 'agile-diamond', u'agile-diamond Documentation',
...
texinfo_documents = [
    ('index', 'agile-diamond', u'agile-diamond Documentation',
    u'Ian Dennis Miller', 'agile-diamond', 'One line description of project.',
    'Miscellaneous'),
]
